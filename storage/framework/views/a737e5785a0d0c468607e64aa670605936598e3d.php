...
uploadField.onchange = function() {
    if(this.files[0].size > 2000000){
       alert("File should not be more than 2mb size");
       this.value = "";
    };
};
...
<?php echo $__env->make('layouts.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/html/NDS/resources/views/pages/create-notification.blade.php ENDPATH**/ ?>