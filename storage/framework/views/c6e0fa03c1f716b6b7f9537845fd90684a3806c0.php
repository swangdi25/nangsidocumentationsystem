      ...
      <li class="active">
        &nbsp;&nbsp;<a href="#homeSubmenu" data-toggle="collapse" aria-expended="false" class="dropdown-toggle text-info"><i class="fas fa-mail-bulk"></i>&nbsp;Letters</a>
          <ul class="show menu" id="homeSubmenu" style="list-style-type: none;">
                ...
                <li><a href="<?php echo e(route('create.create')); ?>" class="text-secondary"><i class="far fa-envelope"></i>&nbsp;Dispatch</a></li>
                <li><a href="<?php echo e(route('notify.create')); ?>" class="text-secondary"><i class="fas fa-bell"></i>&nbsp;Notify</a></li>
                ...
                <li><a href="<?php echo e(route('marked.index')); ?>" class="text-secondary"><i class="far fa-paper-plane"></i>&nbsp;Marked</a></li>
        ...
        &nbsp;&nbsp;<a href="#information" data-toggle="collapse" aria-expended="false" class="dropdown-toggle text-info"><i class="fas fa-info"></i>&nbsp;Information</a>
          <ul class="collapse menu" id="information" style="list-style-type: none;">
                <li><a href="<?php echo e(route('notify.index')); ?>" class="text-secondary"><i class="fas fa-bell-slash"></i>&nbsp;Notification</a></li>
        ...
        &nbsp;&nbsp;<a href="#settingMenu" data-toggle="collapse" aria-expended="false" class="dropdown-toggle text-info"><i class="fas fa-cogs"></i>&nbsp;Setting</a>
          <ul class="collapse menu" id="settingMenu" style="list-style-type: none;">
                <li><a href="<?php echo e(route('profile.index')); ?>" class="text-secondary"><i class="far fa-id-card"></i>&nbsp;Profile</a></li>
                ...
                <li><a href="<?php echo e(route('reference.create')); ?>" class="text-secondary"><i class="fas fa-id-card"></i>&nbsp;Letter Reference</a></li>
          </ul>
        </li>
      </ul>
  </nav>
...
<?php /**PATH /var/www/html/nds/resources/views/layouts/sidenav.blade.php ENDPATH**/ ?>